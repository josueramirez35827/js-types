 ...
 */
const q3 = "Penguins are my favorite animal";
 ...
 */
const address = `Four score and seven years ago our fathers brought forth on this continent, a new nation, conceived in Liberty, and dedicated to the proposition that all men are created equal.
 ...
 */
const periodless = address;
const q11 = /[.]/g;
periodless.replace(q11, '');
console.log(q11)
 ...
 */
const wordlength = address;
const q12 = /[.]/g;
wordlength.replace(q12, '');
...
console.log(calculateAverageOfArray(q13));
